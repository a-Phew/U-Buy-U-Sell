...
<body>
    ...
    <div style="text-align: center">
        ...
        <table style="width: 100%;">
            ...
            <tbody>
                <?php
                    // query to display all items that have been approved and display them on the page
                    $liveItems = "Select * from Live_Items where isApproved= 1 and creatorID != ?";
